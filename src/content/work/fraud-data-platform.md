...
context: "Fraud investigation lives or dies on iteration speed, and mine was throttled by infrastructure rather than by analysis. Two production Redshift clusters disagreed on how to authenticate. One used Midway/SAML SSO, the other a password. A multi-second federated handshake fired on every single query, and each script had to know its own drivers, connection strings, and which cluster it was hitting."
