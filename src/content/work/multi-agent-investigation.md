...
a self-contained folder of numbered scripts, raw CSVs, and a graded report, so
any figure can be clicked back to the exact query behind it.
...
with dozens of leadership reports backed by 800+ scripts and 900+ outputs.

The clearest proof it was worth the overhead came in one debate, where an agent
