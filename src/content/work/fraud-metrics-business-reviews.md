...
outcome: "A number that moved arrived with an explanation instead of a reaction. Reviews spent their time on the moves that were real. A refund-denial threshold got argued over with fraud damage and lost sales both sized, rather than one of the two."
...
That sentence is most of the job. The share of orders flagged as suspicious
